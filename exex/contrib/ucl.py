...
project = ""
[local.storage]
staging = "/home/<your username>/.cache/exex"
...
[clusters.storage]
staging = "/home/<your user name>/exex-staging"
...
[clusters.storage]
staging = "/scratch/scratch/<your user name>/exex-staging"
...
either setting requirements.location or using $EXEX_CLUSTER environment variable.
...
from exex.xm_cluster import executors as cluster_executors
